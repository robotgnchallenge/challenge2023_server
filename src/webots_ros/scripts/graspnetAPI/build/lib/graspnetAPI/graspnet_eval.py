...
class GraspNetEval(GraspNet):
    ...
    **Input:**
    ...
    def eval_scene(self, scene_id, dump_folder, TOP_K = 50, return_list = False,vis = True, max_width = 0.1):
        '''
        **Input:**
        ...
        **Output:**
        ...
        for ann_id in range(1):
            ...
            grasp_list, score_list, collision_mask_list = eval_grasp(grasp_group, model_sampled_list, dexmodel_list, obj_list, pose_list, config, table=table_trans, voxel_size=0.008, TOP_K = TOP_K)
